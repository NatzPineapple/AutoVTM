...
const CAMPANHAS = [
  ...
  {
    /* A primeira campanha COMPILÁVEL do projeto (§72). Existe para dar
       ao usuário uma mesa de verdade onde exercitar o Árbitro e o
       Cronista à mão — as cinco de `campanhas/` são documentos de
       extração dos PDFs, e continuam devolvendo grafo vazio (G1). */
    id: 'conta_duarte',
    nome: 'A Conta do Duarte',
    arquivo: 'campanhas/a-conta-do-duarte.md',
    cidade: 'rio',
    capitulos: 2,
    ifAlvo: '20 a 34',
    resumo: 'Uma noite, oito cenas, um fim. Duarte cobra um empréstimo que você não lembra '
          + 'de ter pedido, e o prazo é o amanhecer. Cada cena cobra uma coisa diferente do '
          + 'motor: caça, arrombamento, escalada, combate armado, arremesso e disputa social.',
    tom: 'Dívida e chantagem — feita para testar o Árbitro e o Cronista'
  }
];
